...
# My default installation for new computer
...
#show taskbar on multiple windows
Set-ItemProperty -Path HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced -Name MMTaskbarMode -Value 2

#Set taskbar to never combine ### depreceited in favor of more consistent use in tweaks function
# REG ADD "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced" /V TaskbarGlomLevel /T REG_DWORD /D 0 /F

###########################
#### Credits for original function and options presentation script structure
...
$tweaks = @(
    ...
    "HideMoveMyDocAppFolderLocation",
    ...
    ################################
    ### Due to 18.04 coming out the below method is defunct for now
...
Function HideMoveMyDocAppFolderLocation {
    Set-ItemProperty -Path "HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\User Shell Folders" -Name "Personal" -Type ExpandString -Value '%USERPROFILE%\AppData\Roaming\My Documents'
}
...
Write-Output "Tweaks Loop has run"
Write-Output "###########################################################################"
Write-Output "###########################################################################"
Write-Output "###########################################################################"
Write-Output "###########################################################################"
...
##############################################
# End of the Win10 Tweak script
##########################################

#--- Hide Navigation Pane Extras ---
#Remove Videos 
...
#Add Snipping Tool to context menu
Write-Output "Snipping context menu adding..."
if((Test-Path -LiteralPath "HKLM:\SOFTWARE\Classes\Directory\Background\Shell\ScreenSnip") -ne $true) {  New-Item "HKLM:\SOFTWARE\Classes\Directory\Background\Shell\ScreenSnip" -force -ea SilentlyContinue };
if((Test-Path -LiteralPath "HKLM:\SOFTWARE\Classes\Directory\Background\Shell\ScreenSnip\command") -ne $true) {  New-Item "HKLM:\SOFTWARE\Classes\Directory\Background\Shell\ScreenSnip\command" -force -ea SilentlyContinue };
New-ItemProperty -LiteralPath 'HKLM:\SOFTWARE\Classes\Directory\Background\Shell\ScreenSnip' -Name 'MUIVerb' -Value "Screen snip" -PropertyType String -Force -ea SilentlyContinue;
New-ItemProperty -LiteralPath 'HKLM:\SOFTWARE\Classes\Directory\Background\Shell\ScreenSnip' -Name 'Icon' -Value "SnippingTool.exe" -PropertyType String -Force -ea SilentlyContinue;
New-ItemProperty -LiteralPath 'HKLM:\SOFTWARE\Classes\Directory\Background\Shell\ScreenSnip' -Name 'Position' -Value "Top" -PropertyType String -Force -ea SilentlyContinue;
New-ItemProperty -LiteralPath 'HKLM:\SOFTWARE\Classes\Directory\Background\Shell\ScreenSnip\command' -Name 'SnipScreen' -Value "explorer.exe ms-screenclip:" -PropertyType String -Force -ea SilentlyContinue;
...
# For now we're going to load WSL manually
# Going to have to anyway since I will need to create the Unix user and then run a bash script to get all the Ubuntu stuff set up. 



Write-Output "Installing System and CLI tools..."
#--- System/CLI Tools ---#
# tools which are often used by other tools
...
Write-Output "InstalledCLI tools"

Write-Output "Installing System tweaks..."
#-- System Tweaks --#
# Defined as invisible or passive modifications to the entire system
...
choco install -y nexusfont.install
choco install zazu -y
choco install displayfusion -y --pre
choco install start10
Write-Output "Installed System Tweaks"

Write-Output "Installing Utilities..."
#--- Utilities --#
# system utilities that are actively used. 
choco install -y rambox
choco install -y qbittorrent
choco install -y 7zip.install
choco install -y ccleaner
choco install ccenhancer -y
choco install -y belvedere
choco install -y peazip.install
choco install -y windirstat
choco install cpu-z -y
choco install gpu-z -y
Write-Output "Installed Utilties"
...
choco install ndm -y
Write-Output "Installed dev tools"

Write-Output "Installing creative tools...."
#--- Creative Tools --#
...
Write-Output "Installed creative tools"
...
Write-Output "InstalledCLI Browsers"

Write-Output "Installing media..."
#--- Media Tools ---#
...
# Checkpoint-Computer -Description "PointBeforeTweakers" -RestorePointType "MODIFY_SETTINGS"
# Write-Output "Restore point created"

Write-Output "Installing tweak tools..."
#--- Tweaker GUI --#
...
choco install -y windows-tweaker.install
Write-Output "Installed Tweak tools"
